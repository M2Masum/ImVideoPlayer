    ...
    // Encapsulate the entire video player in a namespace
    const ImVideoPlayer = (function () {
        // Initialize all video containers
        const videoContainers = document.querySelectorAll(".video-container");

        videoContainers.forEach((container) => {
            // Private variables and functions for each video container
        ...
        return {
            init: function () {
                console.log("ImVideoPlayer initialized for all video containers.");
            },
        };
    })();
